jQuery(document).ready(function ($) {
    "use strict";
    function emeriss_google_maps() {
        if ($('.emeriss-google-maps').length <= 0) {
            return;
        }
        $('.emeriss-google-maps').each(function () {
            var $this = $(this),
                $id = $this.attr('id'),
    ...
    function emeriss_init_menu_toggle() {
        var contain = '.emeriss-nav-toggle';
    ...
    // ----------emeriss_custom_scrollbar-------------------
    function emeriss_custom_scrollbar() {
        $('.emeriss-mini-cart .minicart-items').mCustomScrollbar();
        $('.emeriss-mini-cart .minicart-items').change(function () {
            $('.emeriss-mini-cart .minicart-items').mCustomScrollbar();
        });
    }

    function emeriss_custom_scrollbar_header_nav() {
    ...
    //------------------ Video Lightbox------------
    function emeriss_video() {
        $('.quick-install').simpleLightboxVideo();
    }

    // --------------------remove_class_equal--------------------------
    function emeriss_remove_class_review() {
    ...
    // -----------emeriss_details_thumd--------------------
    function emeriss_details_thumd_zoom() {
        /* ------------------------------------------------
         Arctic modal
         ------------------------------------------------ */
        if ($.arcticmodal) {
    ...
    /* TOGGLE */
    function emeriss_dropdown() {
        $(document).on('click', '.header-control .close', function () {
            $(this).closest('.emeriss-dropdown').removeClass('open');
        });
        $(document).on('click', function (event) {
            var _target = $(event.target).closest('.emeriss-dropdown');
            var _allparent = $('.emeriss-dropdown');

            if (_target.length > 0) {
                _allparent.not(_target).removeClass('open');
                if (
                    $(event.target).is('[data-emeriss="emeriss-dropdown"]') ||
                    $(event.target).closest('[data-emeriss="emeriss-dropdown"]').length > 0
                ) {
                    _target.toggleClass('open');
                    return false;
                }
            } else {
                $('.emeriss-dropdown').removeClass('open');
            }
        });
    }

    function emeriss_mobile_block() {
    ...
    // =====================slick============================
    function emeriss_init_carousel() {
    ...
    /* ---------------------------------------------
     TAB EFFECT
     --------------------------------------------- */
    function emeriss_tab_fade_effect() {
        // effect click
        $(document).on('click', '.emeriss-tabs .tab-link a', function () {
...
// ------------------owl-thumbs-----------------------------------------------
    ...
    function emeriss_countdown() {
        if ($('.emeriss-countdown').length > 0) {
            ...
            $('.emeriss-countdown').each(function () {
    ...
    $(window).resize(function () {
        ...
        emeriss_masonry()
        kt_resizeMegamenu();
        emeriss_remove_class_review();
        emeriss_details_thumd_zoom();
        emeriss_custom_scrollbar();
    });
    $(window).load(function () {
        newletter_popup();
        quickview_popup();
        emeriss_mobile_block();
        emeriss_remove_class_review();
        emeriss_custom_scrollbar()
    });
    emeriss_masonry()
    emeriss_dropdown();
    emeriss_init_carousel();
    emeriss_remove_class_review();
    emeriss_tab_fade_effect();
    emeriss_details_thumd_zoom();
    emeriss_video();
    kt_resizeMegamenu();
    emeriss_custom_scrollbar();
    emeriss_countdown();
    emeriss_init_menu_toggle();
    emeriss_custom_scrollbar_header_nav();
}); 