...
/**
 * Servlet implementation class AdminAddGoodsServlet
 */
@WebServlet("/AdminAddGoodsServlet")
public class AdminAddGoodsServlet extends BaseServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		 ...
		 * 1. 获取真实路径
		 */
		savepath = this.getServletContext().getRealPath("/img");
		/*
		 * 2. 创建目标文件
		 */
